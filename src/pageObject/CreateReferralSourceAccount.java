...
public class CreateReferralSourceAccount {
	...
	public void clearAdd(){
		driver.findElement(addLine1Txtbox).clear();
		driver.findElement(addLine2Txtbox).clear();
		driver.findElement(cityTxtbox).clear();
		driver.findElement(zipTxtbox).clear();
		AllMethod.selectTextFromComboByVisibleTextUseBy(stateListbox,"--None--");
	}
	...
	public void enterDataOnThePage(String name,String lName,String fName,String gender,String phone,String eMail) throws Exception{
		enterTxtOnAccountName(name);
		//enterTxtOnProviderAccount(proName);
		//checkReferralSGIndicator();
		//selectReferralSCategory(rcategory);String rcategory,String rSubCategory,
		//selectReferralSSubCategory(rSubCategory);
		enterTxtOnLastName(lName);
		enterTxtOnFirstName(fName);
		selectGender(gender);
		enterPhone(phone);
		enterEmail(eMail);
		address("245 1st ave","", "New York", "NY","10012");
		checkAutoAddressCopy();
		selectPrimaryLanguage("English");
	}
	
	
	public void clearAllData(){
		driver.findElement(accNameTxtbox).clear();
		driver.findElement(providerAccTxtbox).clear();
		driver.findElement(lNameTxtbox).clear();
		driver.findElement(fNameTxtbox).clear();
		AllMethod.selectTextFromComboByVisibleTextUseBy(genderListbox,"--None--");
